...
// Update property listing complete state to allow listing more
const successScreen = `
  if (success) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 max-w-lg text-center">
          ...
          <div className="flex gap-4 justify-center">
            <button onClick={() => { setSuccess(false); setForm(initialForm); }} className="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold rounded-xl transition">
              {locale === "th" ? "ลงประกาศอีกครั้ง" : "List Another Property"}
            </button>
