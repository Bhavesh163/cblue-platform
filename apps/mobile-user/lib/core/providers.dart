...
class Translations {
  static const Map<String, Map<String, String>> _strings = {
    // App
    'app_title': {'en': 'Cblue', 'th': 'Cblue', 'zh': 'Cblue'},
    // Nav
    ...
    'location_method': {'en': 'Location Method', 'th': 'วิธีระบุตำแหน่ง', 'zh': '定位方式'},
    'use_gps': {'en': 'Use GPS', 'th': 'ใช้ GPS', 'zh': '使用GPS'},
    'use_postal_code': {'en': 'Enter Postal Code', 'th': 'กรอกรหัสไปรษณีย์', 'zh': '输入邮编'},
    'use_address': {'en': 'Enter Address', 'th': 'กรอกที่อยู่', 'zh': '输入地址'},
