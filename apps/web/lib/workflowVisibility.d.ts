...
export function isClosedWorkflowActivity(value?: any): boolean;
export function isWorkflowOrderCancellable(value?: any): boolean;
export function isWorkflowOrderChatEnabled(value?: any): boolean;
export function isCustomerMeetingInviteActionAvailable(value?: any): boolean;
