...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    bullet6: "You may request access, correction, or deletion of your personal data at any time by contacting support@cblue.co.th.",
    ...
    disclaimer: "CBLUE acts as a matching platform only. The agreed price, scope of work, and payment between you and the partner (fixer/professional/property lister) is a direct arrangement between both parties. CBLUE is not responsible for pricing disputes, work quality, or agreements made after the matching process. Both parties acknowledge this upon paying the processing fee.",
  ...
  th: {
    ...
    bullet6: "คุณสามารถขอเข้าถึง แก้ไข หรือลบข้อมูลส่วนบุคคลของคุณได้ตลอดเวลา โดยติดต่อ support@cblue.co.th",
  ...
  zh: {
    ...
    bullet6: "您可以随时通过联系 support@cblue.co.th 请求访问、更正或删除您的个人数据。",
    bullet7: "CBLUE 采用行业标准安全措施，包括加密和访问控制来保护您的数据。",
    disclaimer: "CBLUE 仅作为匹配平台。您与合作伙伴（技工/专业人士/房产经纪人）之间的价格、工作范围和付款是双方的直接安排。CBLUE 不对匹配过程后的定价纠纷、工作质量或协议承担责任。双方在支付处理费时确认此事。",
  ...
  const content = (
    <div className="space-y-4">
      ...
      <div className="bg-red-50 border border-red-200 rounded-xl p-4">
        <h3 className="text-sm font-bold text-red-800 mb-2 flex items-center gap-2">⚠️ {t("disclaimerTitle")}</h3>
