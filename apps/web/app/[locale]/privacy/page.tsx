...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    s8: "Retention is purpose-limited under CBLUE PDPA policy: consent records are retained for 3 years; service history for 18 months; inactive-account personal data and private KYC evidence are deleted after 12 months of inactivity. Legal holds and statutory obligations suspend deletion. Private KYC evidence is stored separately from consent records and is not automatically retained for three years.",
  ...
  th: {
    ...
    s8: "เราเก็บข้อมูลตามวัตถุประสงค์และนโยบาย PDPA ของ CBLUE: บันทึกความยินยอม 3 ปี ประวัติการใช้บริการ 18 เดือน และข้อมูลส่วนบุคคลรวมถึงเอกสาร KYC ของบัญชีที่ไม่ใช้งานจะลบหลังไม่มีการใช้งาน 12 เดือน การระงับตามกฎหมายหรือ legal hold มีผลเหนือกำหนดการลบ",
  ...
  zh: {
    ...
    s8t: "8. 数据保留",
    s8: "CBLUE 按用途执行 PDPA 数据保留政策：同意记录 3 年，服务历史 18 个月，不活跃账户的个人数据和私密 KYC 证据在不活跃 12 个月后删除。法律保留会暂停删除，KYC 证据不会因同意记录而自动保留三年。",
    s9t: "9. 您的权利（根据 PDPA）",
