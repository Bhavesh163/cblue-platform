...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    s1t: "1. Introduction",
    s1: "Construction Blue Co., Ltd. (\"CBLUE\", \"we\", \"us\") is committed to protecting the privacy and personal data of all users. This Privacy Policy explains how we collect, use, store, and protect your personal data in accordance with Thailand's Personal Data Protection Act (PDPA) B.E. 2562 (2019).",
  ...
  th: {
    ...
    s1t: "1. บทนำ",
    s1: "บริษัท คอนสตรัคชั่น บลู จำกัด (\"CBLUE\" \"เรา\") มุ่งมั่นในการปกป้องความเป็นส่วนตัวและข้อมูลส่วนบุคคลของผู้ใช้ทุกคน นโยบายนี้อธิบายวิธีการเก็บรวบรวม ใช้ จัดเก็บ และปกป้องข้อมูลส่วนบุคคลตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562",
  ...
  zh: {
    ...
    s1t: "1. 简介",
    s1: "Construction Blue Co., Ltd. 致力于保护所有用户的隐私和个人数据。本隐私政策说明了我们如何根据泰国个人数据保护法 (PDPA) 收集、使用、存储和保护您的个人数据。",
    s2t: "2. 我们收集的数据",
