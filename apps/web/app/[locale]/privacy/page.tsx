...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    s1t: "1. Introduction",
    s1: "CBLUE Co., Ltd. (\"CBLUE\", \"we\", \"us\") is committed to protecting the privacy and personal data of all users. This Privacy Policy explains how we collect, use, store, and protect your personal data in accordance with Thailand's Personal Data Protection Act (PDPA) B.E. 2562 (2019).",
    ...
    s14t: "14. Contact Us",
    s14: "For privacy-related inquiries or to exercise your data rights:\n• Get Support page: Available through the website footer\n• Email: cblue.thailand@gmail.com\n• Data Protection Officer: CBLUE Co., Ltd., Thailand",
  },
  th: {
    title: "นโยบายความเป็นส่วนตัว",
    subtitle: "แพลตฟอร์ม CBLUE — อัปเดตล่าสุด: 1 มกราคม 2569",
    s1t: "1. บทนำ",
    s1: "บริษัท ซีบลู จำกัด (\"CBLUE\" \"เรา\") มุ่งมั่นในการปกป้องความเป็นส่วนตัวและข้อมูลส่วนบุคคลของผู้ใช้ทุกคน นโยบายนี้อธิบายวิธีการเก็บรวบรวม ใช้ จัดเก็บ และปกป้องข้อมูลส่วนบุคคลตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562",
    ...
    s9: "คุณมีสิทธิ:\n• เข้าถึงข้อมูล\n• แก้ไขข้อมูล\n• ลบข้อมูล\n• จำกัดการประมวลผล\n• ส่งออกข้อมูล\n• คัดค้าน\n• ถอนความยินยอม\n\nติดต่อผ่านหน้า Get Support หรือ cblue.thailand@gmail.com",
    ...
    s14t: "14. ติดต่อเรา",
    s14: "สำหรับเรื่องความเป็นส่วนตัว:\n• หน้า Get Support\n• อีเมล: cblue.thailand@gmail.com\n• เจ้าหน้าที่คุ้มครองข้อมูล: CBLUE Co., Ltd. ประเทศไทย",
  },
  zh: {
    title: "隐私政策",
    subtitle: "CBLUE 平台 — 最后更新：2026年1月1日",
    s1t: "1. 简介",
    s1: "CBLUE Co., Ltd. 致力于保护所有用户的隐私和个人数据。本隐私政策说明了我们如何根据泰国个人数据保护法 (PDPA) 收集、使用、存储和保护您的个人数据。",
    s2t: "2. 我们收集的数据",
    ...
    s8: "保留期限：\n• 账户数据：直到删除或3年不活动\n• 预约记录：5年\n• 聊天消息：服务完成后1年\n• KYC 文件：账户期间+2年\n• 支付记录：7年",
    s9t: "9. 您的权利（根据 PDPA）",
    s9: "您有权：\n• 访问数据\n• 更正数据\n• 删除数据\n• 限制处理\n• 数据可携带\n• 反对处理\n• 撤回同意\n\n联系：Get Support 页面或 cblue.thailand@gmail.com",
    s10t: "10. Cookie 和跟踪",
    s10: "我们使用必要 Cookie：\n• 认证和会话管理\n• 语言偏好\n• 订阅者会话数据\n\n不使用第三方广告 Cookie。",
    s11t: "11. 儿童隐私",
