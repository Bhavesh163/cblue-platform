...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: [
      "Cblue", "ซีบลู", "ช่างซ่อมบ้าน", "หาช่างซ่อมบ้าน", "มืออาชีพ", "หามืออาชีพ",
      "เจ้าหน้าที่ความปลอดภัย", "หาเจ้าหน้าที่ความปลอดภัย", "ตรวจประจำปี", "วิศวกรกรควบคุมงาน",
      "หาวิศวกรกรควบคุมงาน", "ผู้ตรวจสอบบัญชี", "หาผู้ตรวจสอบบัญชี", "ผู้ออกแบบ", "หาผู้ออกแบบ",
      "ขายบ้าน", "ขายคอนโด", "ขายโกดัง", "ขายที่ดิน", "ขายโรงงาน", "ขายอาคาร", "บ้าน",
      "คอนโด", "โกดัง", "ที่ดิน", "โรงงาน", "อาคาร", "ออฟฟิศ", "บ้านให้เช่า", "คอนโดให้เช่า",
      "โกดังให้เช่า", "ที่ดินให้เช่า", "โรงงานให้เช่า", "อาคารให้เช่า", "บ้านมือสอง", "คอนโดมือสอง",
      "โกดังมือสอง", "ที่ดินมือสอง", "โรงงานมือสอง", "อาคารมือสอง", "เช่าบ้าน", "เช่าคอนโด",
      "เช่าโกดัง", "เช่าที่ดิน", "เช่าโรงงาน", "เช่าอาคาร", "เช่าออฟฟิศ", "หาทาวน์เฮ้าส์",
      "ทาวน์เฮ้าส์ให้เช่า", "ทาวน์เฮ้าส์มือสอง", "ซื้อทาวน์เฮ้าส์", "ขายทาวน์เฮ้าส์",

      "House repair fixer", "Find fixer", "Professional", "Find professional",
      "Safety Officer", "Annual inspection", "Supervising Engineer",
      "Auditor", "Designer",
      "House for sale", "Condo for sale", "Warehouse for sale", "Land for sale", "Factory for sale",
      "Building for sale", "House", "Condo", "Warehouse", "Land", "Factory", "Building", "Office",
      "House for rent", "Condo for rent", "Warehouse for rent", "Land for rent", "Factory for rent",
      "Building for rent", "Second-hand house", "Second-hand condo", "Second-hand warehouse",
      "Second-hand land", "Second-hand factory", "Second-hand building", "Rent house", "Rent condo",
      "Rent warehouse", "Rent land", "Rent factory", "Rent building", "Rent office", "Find townhouse",
      "Townhouse for rent", "Second-hand townhouse", "Buy townhouse", "Sell townhouse",
      "Lawyer", "Accountant", "CPA", "Architect", "Interior Designer", "Design Civil Engineer",
      "Construction Civil Engineer", "Design Mechanical Engineer", "Construction Mechanical Engineer",
      "Design Electrical Engineer", "Construction Electrical Engineer", "Software Programmer",
      "Digital Marketing", "Safety manager", "HSE manager", "firelifesafety", "FLS",

      "房屋维修工", "找维修工", "专业人士", "找专业人士", "安全员", "找安全员",
      "年度检查", "监理工程师", "找监理工程师", "审计师", "找审计师", "设计师", "找设计师",
      "卖房", "卖公寓", "卖仓库", "卖土地", "卖工厂", "卖建筑", "房子", "公寓", "仓库",
      "土地", "工厂", "建筑", "办公室", "房屋出租", "公寓出租", "仓库出租", "土地出租",
      "工厂出租", "建筑出租", "二手房", "二手公寓", "二手仓库", "二手土地", "二手工厂",
      "二手建筑", "租房", "租公寓", "租仓库", "租土地", "租工厂", "租建筑", "办公室出租",
      "找联排别墅", "联排别墅出租", "二手联排别墅", "买联排别墅", "卖联排别墅",
      "律师", "会计师", "注册会计师", "建筑师", "室内设计师", "土木设计工程师", "土木施工工程师",
      "机械设计工程师", "机械施工工程师", "电气设计工程师", "电气施工工程师", "软件程序员",
      "数字营销", "安全经理", "HSE经理", "消防安全",
      // Brand
