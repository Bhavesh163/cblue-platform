...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
    "Book a Fixer in Thailand", "Find a Handyman Near Me", "Property Rental Marketplace Thailand", "Home Repair Services Thailand", "Professional Services Marketplace Thailand", "Thailand Property Platform", "Thailand Service Marketplace", "Real Estate Listing Thailand", "handyman Thailand", "fixer Thailand", "renovation team Thailand", "property listing Thailand", "property rental Thailand",
    "จองช่างซ่อมออนไลน์", "หาช่างใกล้ฉัน", "บริการซ่อมบ้าน", "แพลตฟอร์มหาช่าง", "รวมช่างมืออาชีพ", "ลงประกาศอสังหาริมทรัพย์", "ค้นหาอสังหาริมทรัพย์", "จองผู้เชี่ยวชาญออนไลน์", "ช่างใกล้บ้าน", "ช่างไฟฟ้า", "ช่างประปา", "รับเหมาก่อสร้าง", "ขายบ้าน", "ซื้อบ้าน", "เช่าคอนโด",
    "泰国维修服务平台", "泰国找师傅", "泰国家居维修", "泰国专业服务平台", "泰国房产平台", "泰国房产出租", "泰国房产买卖", "在线预约专业服务", "泰国装修团队", "泰国房产出售",
