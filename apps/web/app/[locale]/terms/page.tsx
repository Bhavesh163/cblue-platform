...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    s11: "All content, trademarks, and intellectual property on the CBLUE platform belong to cblue. Users may not reproduce, distribute, or create derivative works without written permission.",
  ...
  th: {
    ...
    s11: "เนื้อหาและทรัพย์สินทางปัญญาทั้งหมดบนแพลตฟอร์ม CBLUE เป็นของ cblue",
  ...
  zh: {
    ...
    s11t: "11. 知识产权",
    s11: "CBLUE 平台上的所有内容和知识产权归 cblue 所有。",
    s12t: "12. 适用法律",
