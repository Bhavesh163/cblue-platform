...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    subtitle: "CBLUE Platform — Effective Date: January 1, 2026",
    s1t: "1. Acceptance of Terms",
    s1: "By accessing or using the CBLUE platform (website and mobile applications), you agree to be bound by these Terms of Service. If you do not agree, please do not use our services.",
    s2t: "2. Services Provided",
    s2: "CBLUE provides a marketplace platform connecting customers with certified fixers, professionals, and real estate service providers across Thailand. Our services include:\n• Household maintenance booking (Plumbing, Electrical, AC, Interior, Landscaping, Gardening, Cladding/Roofing)\n• Project services (Website Dev, AI, Solar, Smart Building, Green Construction, etc.)\n• Professional services (Lawyers, Architects, Engineers, Accountants, etc.)\n• Real estate listing and search (Condo, House, Townhouse, Land, Commercial, Apartment)",
    s3t: "3. User Accounts & Registration",
    s3: "Users must provide accurate and complete information during registration. You are responsible for maintaining the confidentiality of your account credentials. CBLUE reserves the right to suspend or terminate accounts that violate these terms or engage in fraudulent activity.",
    ...
    s5: "Fixers and professionals registered on CBLUE must:\n• Complete KYC identity verification\n• Provide accurate service descriptions and pricing\n• Maintain professional conduct with customers\n• Comply with all applicable Thai laws and regulations\n\nCBLUE reserves the right to de-list or suspend fixers/professionals who receive repeated negative reviews or violate platform policies.",
    s6t: "6. Real Estate Listings",
    s6: "Property listings must contain accurate information including property type, location, price, and contact details. CBLUE does not guarantee the accuracy of listings and is not a party to any real estate transaction. Sellers and renters are responsible for the accuracy of their listings.",
    s7t: "7. Tier System & Quality Standards",
    s7: "CBLUE operates a 5-tier quality system. Tier assignment is based on experience, qualifications, and customer satisfaction ratings. Fixers with corporate-level experience may qualify for Corporate tier; those with luxury/famous project experience may qualify for Specialist or Expert tier. CBLUE reserves the right to adjust tier assignments based on ongoing performance.",
    ...
    s11: "All content, trademarks, and intellectual property on the CBLUE platform belong to Construction Blue Co., Ltd. Users may not reproduce, distribute, or create derivative works without written permission.",
  ...
  th: {
    ...
    subtitle: "แพลตฟอร์ม CBLUE — มีผลบังคับใช้: 1 มกราคม 2569",
    s1t: "1. การยอมรับข้อกำหนด",
    s1: "การเข้าถึงหรือใช้แพลตฟอร์ม CBLUE (เว็บไซต์และแอปพลิเคชันมือถือ) ถือว่าคุณยอมรับข้อกำหนดการใช้บริการเหล่านี้ หากคุณไม่ยอมรับ กรุณาอย่าใช้บริการของเรา",
    s2t: "2. บริการที่ให้",
    s2: "CBLUE เป็นแพลตฟอร์มตลาดกลางที่เชื่อมต่อลูกค้ากับช่าง มืออาชีพ และผู้ให้บริการอสังหาริมทรัพย์ที่ได้รับการรับรองทั่วประเทศไทย บริการของเราประกอบด้วย:\n• การจองบำรุงรักษาบ้าน (ประปา ไฟฟ้า แอร์ ตกแต่งภายใน จัดสวน ทำสวน หลังคา/ผนัง)\n• บริการโครงการ (พัฒนาเว็บ AI โซลาร์ อาคารอัจฉริยะ ก่อสร้างสีเขียว ฯลฯ)\n• บริการมืออาชีพ (ทนายความ สถาปนิก วิศวกร นักบัญชี ฯลฯ)\n• ลงประกาศและค้นหาอสังหาริมทรัพย์ (คอนโด บ้าน ทาวน์เฮาส์ ที่ดิน พาณิชย์ อพาร์ทเมนท์)",
    s3t: "3. บัญชีผู้ใช้และการลงทะเบียน",
    s3: "ผู้ใช้ต้องให้ข้อมูลที่ถูกต้องและครบถ้วนในการลงทะเบียน คุณรับผิดชอบในการรักษาความลับของข้อมูลบัญชี CBLUE ขอสงวนสิทธิ์ในการระงับหรือยกเลิกบัญชีที่ละเมิดข้อกำหนดหรือมีการฉ้อโกง",
    ...
    s5: "ช่างและมืออาชีพต้อง:\n• ผ่านการยืนยันตัวตน KYC\n• ให้ข้อมูลบริการและราคาที่ถูกต้อง\n• ประพฤติตนอย่างมืออาชีพ\n• ปฏิบัติตามกฎหมายไทย\n\nCBLUE ขอสงวนสิทธิ์ในการระงับช่าง/มืออาชีพที่ได้รับรีวิวเชิงลบซ้ำหรือละเมิดนโยบาย",
    s6t: "6. ประกาศอสังหาริมทรัพย์",
    s6: "ประกาศอสังหาริมทรัพย์ต้องมีข้อมูลที่ถูกต้อง CBLUE ไม่รับประกันความถูกต้องของประกาศและไม่ใช่คู่สัญญาในธุรกรรมอสังหาริมทรัพย์",
    s7t: "7. ระบบระดับและมาตรฐานคุณภาพ",
    s7: "CBLUE ดำเนินระบบคุณภาพ 5 ระดับ การกำหนดระดับขึ้นอยู่กับประสบการณ์ คุณสมบัติ และคะแนนความพึงพอใจ ผู้มีประสบการณ์ระดับองค์กรอาจได้รับระดับ Corporate ผู้มีประสบการณ์โครงการหรู/มีชื่อเสียงอาจได้รับระดับ Specialist หรือ Expert",
    s8t: "8. การติดต่อสื่อสารแบบไม่ระบุตัวตน",
    s8: "การสื่อสารทั้งหมดระหว่างลูกค้าและช่าง/มืออาชีพผ่านระบบแชท CBLUE เป็นแบบไม่ระบุตัวตน ข้อมูลส่วนตัวจะไม่ถูกแชร์จนกว่าทั้งสองฝ่ายจะยินยอม",
    s9t: "9. การยกเลิกและการคืนเงิน",
    s9: "ลูกค้าสามารถยกเลิกการจองได้ก่อนที่ช่าง/มืออาชีพจะยืนยัน หลังยืนยันและชำระค่าธรรมเนียมแล้ว การขอคืนเงินเป็นไปตามนโยบายของ CBLUE ต้องส่งคำขอภายใน 7 วัน",
    s10t: "10. ข้อจำกัดความรับผิดชอบ",
    s10: "CBLUE เป็นแพลตฟอร์มตลาดกลาง ไม่ได้รับผิดชอบโดยตรงต่อคุณภาพงาน ความรับผิดของ CBLUE จำกัดที่ค่าธรรมเนียมดำเนินการ",
    s11t: "11. ทรัพย์สินทางปัญญา",
    s11: "เนื้อหาและทรัพย์สินทางปัญญาทั้งหมดบนแพลตฟอร์ม CBLUE เป็นของ บริษัท คอนสตรัคชั่น บลู จำกัด (Construction Blue Co., Ltd.)",
  ...
  zh: {
    title: "服务条款",
    subtitle: "CBLUE 平台 — 生效日期：2026年1月1日",
    s1t: "1. 接受条款",
    s1: "访问或使用 CBLUE 平台（网站和移动应用）即表示您同意受这些服务条款的约束。如不同意，请勿使用我们的服务。",
    s2t: "2. 提供的服务",
    s2: "CBLUE 提供一个市场平台，连接客户与经过认证的技工、专业人员和房地产服务提供商。服务包括：\n• 家庭维修预约（水管、电气、空调、室内装饰、园艺、屋顶/外墙）\n• 项目服务（网站开发、AI、太阳能、智能建筑、绿色建筑等）\n• 专业服务（律师、建筑师、工程师、会计师等）\n• 房地产发布和搜索（公寓、别墅、联排、土地、商业、公寓）",
    s3t: "3. 用户账户与注册",
    s3: "用户必须在注册时提供准确完整的信息。您有责任维护账户凭据的保密性。CBLUE 保留暂停或终止违反条款或从事欺诈活动的账户的权利。",
    s4t: "4. 预约与付款",
    s4: "预约技工或专业人员时，需根据所选等级支付处理费：\n• Economy: ฿100\n• Standard: ฿400\n• Corporate / Upper: ฿600\n• Specialist / Manager / Luxury: ฿800\n• Expert / Director / Grandeur: ฿1,000\n\n通过 PromptPay QR 支付。技工/专业人员确认预约后，费用不可退还，法律规定除外。",
    s5t: "5. 技工与专业人员义务",
    s5: "技工和专业人员必须：\n• 完成 KYC 身份验证\n• 提供准确的服务描述和定价\n• 对客户保持专业态度\n• 遵守泰国法律法规",
    s6t: "6. 房地产发布",
    s6: "房产发布必须包含准确信息。CBLUE 不保证发布的准确性，不是任何房地产交易的当事方。",
    s7t: "7. 等级系统与质量标准",
    s7: "CBLUE 运营5级质量体系。等级分配基于经验、资质和客户满意度评分。",
    s8t: "8. 匿名通信",
    s8: "通过 CBLUE 聊天系统的所有通信都是匿名的。在双方同意前不会共享个人联系信息。",
    s9t: "9. 取消与退款",
    s9: "客户可在技工/专业人员确认前取消预约。确认并支付处理费后，退款须符合 CBLUE 退款政策。",
    s10t: "10. 责任限制",
    s10: "CBLUE 作为市场平台，不直接负责工作质量。CBLUE 的总责任不超过相关处理费。",
    s11t: "11. 知识产权",
    s11: "CBLUE 平台上的所有内容和知识产权归 Construction Blue Co., Ltd. 所有。",
    s12t: "12. 适用法律",
