...
# Replace layout.tsx metadata
head -n 2 apps/web/app/[locale]/layout.tsx > /tmp/head.txt
tail -n +12 apps/web/app/[locale]/layout.tsx > /tmp/tail.txt
cat /tmp/head.txt /tmp/layout.txt /tmp/tail.txt > apps/web/app/[locale]/layout.tsx
