SYSTEM_KNOWLEDGE = """# Cblue Thailand AI Assistant - System Knowledge Base
...
SYSTEM_PROMPT = f"""{SYSTEM_KNOWLEDGE}
...
LEGAL_DISCLAIMER = """⚠️ ข้อจำกัดความรับผิด: ข้อมูลนี้เป็นเพียงข้อมูลทั่วไป ไม่ใช่คำแนะนำทางกฎหมาย กรุณาปรึกษาผู้เชี่ยวชาญ"""
